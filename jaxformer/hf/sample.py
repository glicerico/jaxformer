...
def main():
    ...
    models_pl = ['codegen-6B-multi-fullamr-torch', 'codegen-350M-multi', 'codegen-1B-multi', 'codegen-2B-multi', 'codegen-6B-multi', 'codegen-16B-multi', 'codegen-350M-mono', 'codegen-2B-mono', 'codegen-6B-mono', 'codegen-16B-mono']
